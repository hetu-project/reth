...
#[derive(Debug)]
pub struct ProviderFactory<DB, NP> {
    /// Database
    db: Arc<DB>,
    /// Chain spec
...
impl<DB, NP> ProviderFactory<DB, NP> {
...
impl<NP> ProviderFactory<DatabaseEnv, NP> {
...
impl<DB: Database, NP: NodePrimitives> ProviderFactory<DB, NP> {
...
impl<DB: Database, NP: NodePrimitives> DatabaseProviderFactory<DB> for ProviderFactory<DB, NP> {
    fn database_provider_ro(&self) -> ProviderResult<DatabaseProviderRO<DB>> {
        self.provider()
    }
}

impl<DB, NP> StaticFileProviderFactory for ProviderFactory<DB, NP> {
...
impl<DB: Database, NP: NodePrimitives> HeaderSyncGapProvider for ProviderFactory<DB, NP> {
    fn sync_gap(
        &self,
...
impl<DB: Database, NP: NodePrimitives> HeaderProvider for ProviderFactory<DB, NP> {
...
impl<DB: Database, NP: NodePrimitives> BlockHashReader for ProviderFactory<DB, NP> {
...
impl<DB: Database, NP: NodePrimitives> BlockNumReader for ProviderFactory<DB, NP> {
...
impl<DB: Database, NP: NodePrimitives> BlockReader for ProviderFactory<DB, NP> {
...
impl<DB: Database, NP: NodePrimitives> TransactionsProvider for ProviderFactory<DB, NP> {
...
impl<DB: Database, NP: NodePrimitives> ReceiptProvider for ProviderFactory<DB, NP> {
...
impl<DB: Database, NP: NodePrimitives> WithdrawalsProvider for ProviderFactory<DB, NP> {
...
impl<DB, NP: NodePrimitives> RequestsProvider for ProviderFactory<DB, NP>
where
    DB: Database,
{
...
impl<DB: Database, NP: NodePrimitives> StageCheckpointReader for ProviderFactory<DB, NP> {
...
impl<DB: Database, NP: NodePrimitives> EvmEnvProvider for ProviderFactory<DB, NP> {
...
impl<DB, NP> ChainSpecProvider for ProviderFactory<DB, NP>
where
    DB: Send + Sync,
    NP: NodePrimitives,
{
...
impl<DB: Database, NP: NodePrimitives> PruneCheckpointReader for ProviderFactory<DB, NP> {
...
impl<DB, NP: NodePrimitives> Clone for ProviderFactory<DB, NP> {
    fn clone(&self) -> Self {
        Self {
