...
pub struct BlockchainProvider2<DB, NP> {
...
impl<DB, NP: NodePrimitives> Clone for BlockchainProvider2<DB, NP> {
    fn clone(&self) -> Self {
        Self {
...
impl<DB, NP> BlockchainProvider2<DB, NP>
where
    DB: Database,
    NP: NodePrimitives,
{
    ...
    pub fn new(database: ProviderFactory<DB, NP>) -> ProviderResult<Self> {
...
impl<DB, NP> DatabaseProviderFactory<DB> for BlockchainProvider2<DB, NP>
where
    DB: Database,
    NP: NodePrimitives,
{
...
impl<DB, NP> StaticFileProviderFactory for BlockchainProvider2<DB, NP> {
    fn static_file_provider(&self) -> StaticFileProvider {
        self.database.static_file_provider()
    }
}

impl<DB, NP> HeaderProvider for BlockchainProvider2<DB, NP>
where
    DB: Database,
    NP: NodePrimitives,
{
...
impl<DB, NP> BlockHashReader for BlockchainProvider2<DB, NP>
where
    DB: Database,
    NP: NodePrimitives,
{
...
impl<DB, NP> BlockNumReader for BlockchainProvider2<DB, NP>
where
    DB: Database,
    NP: NodePrimitives,
{
...
impl<DB, NP> BlockIdReader for BlockchainProvider2<DB, NP>
where
    DB: Database,
    NP: NodePrimitives,
{
...
impl<DB, NP> BlockReader for BlockchainProvider2<DB, NP>
where
    DB: Database,
    NP: NodePrimitives,
{
...
impl<DB, NP> TransactionsProvider for BlockchainProvider2<DB, NP>
where
    DB: Database,
    NP: NodePrimitives,
{
...
impl<DB, NP> ReceiptProvider for BlockchainProvider2<DB, NP>
where
    DB: Database,
    NP: NodePrimitives,
{
...
impl<DB, NP> ReceiptProviderIdExt for BlockchainProvider2<DB, NP>
where
    DB: Database,
    NP: NodePrimitives,
{
...
impl<DB, NP> WithdrawalsProvider for BlockchainProvider2<DB, NP>
where
    DB: Database,
    NP: NodePrimitives,
{
...
impl<DB, NP> RequestsProvider for BlockchainProvider2<DB, NP>
where
    DB: Database,
    NP: NodePrimitives,
{
...
impl<DB, NP> StageCheckpointReader for BlockchainProvider2<DB, NP>
where
    DB: Database,
    NP: NodePrimitives,
{
...
impl<DB, NP> EvmEnvProvider for BlockchainProvider2<DB, NP>
where
    DB: Database,
    NP: NodePrimitives,
{
...
impl<DB, NP> PruneCheckpointReader for BlockchainProvider2<DB, NP>
where
    DB: Database,
    NP: NodePrimitives,
{
...
impl<DB, NP> ChainSpecProvider for BlockchainProvider2<DB, NP>
where
    DB: Send + Sync,
    NP: NodePrimitives,
{
...
impl<DB, NP> StateProviderFactory for BlockchainProvider2<DB, NP>
where
    DB: Database,
    NP: NodePrimitives,
{
...
impl<DB, NP> CanonChainTracker for BlockchainProvider2<DB, NP>
where
    DB: Send + Sync,
    NP: NodePrimitives,
    Self: BlockReader,
...
impl<DB, NP> BlockReaderIdExt for BlockchainProvider2<DB, NP>
where
...
impl<DB, NP> CanonStateSubscriptions for BlockchainProvider2<DB, NP>
where
    DB: Send + Sync,
    NP: NodePrimitives,
{
...
impl<DB, NP> ChangeSetReader for BlockchainProvider2<DB, NP>
where
    DB: Database,
    NP: NodePrimitives,
{
...
impl<DB, NP> AccountReader for BlockchainProvider2<DB, NP>
where
