...
pub struct BlockchainProvider<DB, NP> {
    /// Provider type used to access the database.
    database: ProviderFactory<DB, NP>,
...
impl<DB, NP: NodePrimitives> Clone for BlockchainProvider<DB, NP> {
    fn clone(&self) -> Self {
        Self {
...
impl<DB, NP> BlockchainProvider<DB, NP> {
...
impl<DB, NP> DatabaseProviderFactory<DB> for BlockchainProvider<DB, NP>
where
    DB: Database,
    NP: NodePrimitives,
{
...
impl<DB, NP> StaticFileProviderFactory for BlockchainProvider<DB, NP> {
    fn static_file_provider(&self) -> StaticFileProvider {
        self.database.static_file_provider()
    }
}

impl<DB, NP> HeaderProvider for BlockchainProvider<DB, NP>
where
    DB: Database,
    NP: NodePrimitives,
{
...
impl<DB, NP> BlockHashReader for BlockchainProvider<DB, NP>
where
    DB: Database,
    NP: NodePrimitives,
{
...
impl<DB, NP> BlockNumReader for BlockchainProvider<DB, NP>
where
    DB: Database,
    NP: NodePrimitives,
{
...
impl<DB, NP> BlockIdReader for BlockchainProvider<DB, NP>
where
    DB: Database,
    NP: NodePrimitives,
{
...
impl<DB, NP> BlockReader for BlockchainProvider<DB, NP>
where
    DB: Database,
    NP: NodePrimitives,
{
...
impl<DB, NP> TransactionsProvider for BlockchainProvider<DB, NP>
where
    DB: Database,
    NP: NodePrimitives,
{
...
impl<DB, NP> ReceiptProvider for BlockchainProvider<DB, NP>
where
    DB: Database,
    NP: NodePrimitives,
{
...
impl<DB, NP> ReceiptProviderIdExt for BlockchainProvider<DB, NP>
where
    DB: Database,
    NP: NodePrimitives,
{
...
impl<DB, NP> WithdrawalsProvider for BlockchainProvider<DB, NP>
where
    DB: Database,
    NP: NodePrimitives,
{
...
impl<DB, NP> RequestsProvider for BlockchainProvider<DB, NP>
where
    DB: Database,
    NP: NodePrimitives,
{
...
impl<DB, NP> StageCheckpointReader for BlockchainProvider<DB, NP>
where
    DB: Database,
    NP: NodePrimitives,
{
...
impl<DB, NP> EvmEnvProvider for BlockchainProvider<DB, NP>
where
    DB: Database,
    NP: NodePrimitives,
{
...
impl<DB, NP> PruneCheckpointReader for BlockchainProvider<DB, NP>
where
    DB: Database,
    NP: NodePrimitives,
{
...
impl<DB, NP> ChainSpecProvider for BlockchainProvider<DB, NP>
where
    DB: Send + Sync,
    NP: NodePrimitives,
{
...
impl<DB, NP> StateProviderFactory for BlockchainProvider<DB, NP>
where
    DB: Database,
    NP: NodePrimitives,
{
...
impl<DB, NP> BlockchainTreeEngine for BlockchainProvider<DB, NP>
where
    DB: Send + Sync,
    NP: NodePrimitives,
{
...
impl<DB, NP> BlockchainTreeViewer for BlockchainProvider<DB, NP>
where
    DB: Send + Sync,
    NP: NodePrimitives,
{
...
impl<DB, NP> CanonChainTracker for BlockchainProvider<DB, NP>
where
    DB: Send + Sync,
    Self: BlockReader,
{
...
impl<DB, NP> BlockReaderIdExt for BlockchainProvider<DB, NP>
where
...
impl<DB, NP> BlockchainTreePendingStateProvider for BlockchainProvider<DB, NP>
where
    DB: Send + Sync,
    NP: NodePrimitives,
{
...
impl<DB, NP> CanonStateSubscriptions for BlockchainProvider<DB, NP>
where
    DB: Send + Sync,
    NP: NodePrimitives,
{
...
impl<DB, NP> ForkChoiceSubscriptions for BlockchainProvider<DB, NP>
where
    DB: Send + Sync,
    NP: NodePrimitives,
{
...
impl<DB, NP> ChangeSetReader for BlockchainProvider<DB, NP>
where
    DB: Database,
    NP: NodePrimitives,
{
...
impl<DB, NP> AccountReader for BlockchainProvider<DB, NP>
where
